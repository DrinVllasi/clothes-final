...
// Dynamically get all bag images, excluding baggy items
$bag_images = array_merge(
    glob('clothes/womens/women-bag.png'),
    glob('clothes/womens/women-bag (2).png'),
    glob('clothes/womens/unisex-bag.png')
);
$bag_images = array_unique($bag_images);
...
<head>
    ...
    <title>Women's Bags - Devsun</title>
