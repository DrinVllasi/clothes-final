...
// Dynamically get all hoodie images in clothes/womens
$hoodie_images = glob('clothes/womens/*hoodie*.png');
...
<head>
    ...
    <title>Women's Hoodies - Devsun</title>
...
<body>
    ...
    <div class="container-fluid p-0">
        <div class="row g-0">
            <?php foreach ($hoodie_images as $img): 
                $productName = makeProductName($img);
                $price = (stripos($img, 'unisex') !== false) ? '69.99' : '79.99';
            ?>
