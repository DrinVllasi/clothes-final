...
// Dynamically get all skirt images
$skirt_images = glob('clothes/womens/*skirt*.png');
$skirt_images = array_unique($skirt_images);
...
<head>
    ...
    <title>Women's Skirts - Devsun</title>
...
<body>
    <div class="category-title">
        <h2>Women's Skirts</h2>
    </div>

    <div class="container-fluid p-0">
        <div class="row g-0">
            <?php foreach ($skirt_images as $img): 
