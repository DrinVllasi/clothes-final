...
// Dynamically get all boot images
$boot_images = array_merge(
    glob('clothes/womens/*boots*.png'),
    glob('clothes/womens/unisex-boots*.png')
);
$boot_images = array_unique($boot_images);
...
<head>
    ...
    <title>Women's Boots - Devsun</title>
...
<body>
    ...
    <div class="container-fluid p-0">
        <div class="row g-0">
            <?php foreach ($boot_images as $img): 
