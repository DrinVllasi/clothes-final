...
// Dynamically get all jeans images in clothes/womens
$jeans_images = array_merge(
    glob('clothes/womens/*baggy*.png'),
    glob('clothes/womens/*bootcut*.png'),
    glob('clothes/womens/*jorts*.png'),
    glob('clothes/womens/*falre*.png'),
    glob('clothes/womens/*flare*.png')
);
...
$baggy_images = array_filter($jeans_images, function($img) { return stripos($img, 'baggy') !== false; });
$bootcut_images = array_filter($jeans_images, function($img) { return stripos($img, 'bootcut') !== false; });
$flare_images = array_filter($jeans_images, function($img) { return stripos($img, 'flare') !== false || stripos($img, 'falre') !== false; });
$jorts_images = array_filter($jeans_images, function($img) { return stripos($img, 'jorts') !== false; });
?>
...
<head>
    ...
    <title>Women's Jeans - Devsun</title>
...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row g-0">
            <?php foreach ($flare_images as $img): 
                $productName = makeProductName($img);
                $price = '54.99';
            ?>
            <div class="col-6 col-md-4 col-lg-3">
