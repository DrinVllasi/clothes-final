...
// Dynamically get all shoe images
$shoe_images = array_merge(
    glob('clothes/womens/*shoes*.png'),
    glob('clothes/womens/unisex-shoes*.png')
);
$shoe_images = array_unique($shoe_images);
...
<head>
    ...
    <title>Women's Shoes - Devsun</title>
...
<body>
    ...
    <div class="container-fluid p-0">
        <div class="row g-0">
            <?php foreach ($shoe_images as $img): 
